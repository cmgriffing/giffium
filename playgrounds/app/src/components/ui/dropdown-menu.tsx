  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          'z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] animate-content-hide overflow-hidden rounded-md border bg-white p-1 text-black shadow-md data-[expanded]:animate-content-show',
          props.class,
        )}
        {...rest}
      />
...
const DropdownMenuSubTrigger = <T extends ValidComponent = 'div'>(
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      class={cn(
        'flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent focus:text-white data-[state=open]:bg-accent',
        props.class,
      )}
      {...rest}
    >
...
const DropdownMenuSubContent = <T extends ValidComponent = 'div'>(
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      class={cn(
        'z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] overflow-hidden rounded-md border bg-white p-1 text-black shadow-md animate-in',
        props.class,
      )}
      {...rest}
    />
