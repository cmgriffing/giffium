...
const SliderTrack = <T extends ValidComponent = 'div'>(
  ...
  return (
    <SliderPrimitive.Track
      class={cn(
        'relative h-2 w-full grow rounded-full bg-gray-200 focus-visible:bg-black',
        local.class,
      )}
      {...others}
    />
...
const SliderFill = <T extends ValidComponent = 'div'>(
  ...
  return (
    <SliderPrimitive.Fill
      class={cn('absolute h-full rounded-full bg-gray-600 focus-visible:bg-gray-200', local.class)}
      {...others}
    />
  )
}
